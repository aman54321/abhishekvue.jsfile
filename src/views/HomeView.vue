  ...
  <div>
    ...
    <div class="nav-right">
      <router-link to="/login">
        <button :class="{ active: activeButton === 'login' }">Login</button>
      </router-link>
      <router-link to="/signup">
        <button :class="{ active: activeButton === 'signup' }">Sign up</button>
      </router-link>
    </div>
               ...
               <table class="col-600" width="600" height="400" border="0" align="center" cellpadding="0" cellspacing="0">
                 ...
                 <tr>
                   <td align="center" style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:24px; font-weight: bold; letter-spacing: 5px;">
                     WELCOME <span style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:39px; font-weight: 300; letter-spacing: 5px;">TO WELLNESS AND DIET</span>
                   </td>
                 </tr>
           ...
           <tr>
             ...
             <td align="center" bgcolor="#333">
               <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                 ...
                 <tr>
                   <td align="center" style="font-family: 'Raleway', sans-serif; font-size:20px; color:#fbb016; line-height:24px; font-weight: bold;">Our services</td>
                 </tr>
           ...
           <tr>
             <td>
               ...
               <table style="border:1px solid #e2e2e2;" class="col2" width="287" border="0" align="left" cellpadding="0" cellspacing="0">
                 ...
                 <tbody><tr>
                   <td height="40" align="center" bgcolor="#333" style="font-family: 'Raleway', sans-serif; 
                   font-size:18px; color:#fbb016; line-height:30px; font-weight: bold;">Check the BMI</td>
                 </tr>
                   ...
                   <td align="center">
                     <table class="insider" width="237" border="0" align="center" cellpadding="0" cellspacing="0">
                       ...
                       <tr align="center" style="line-height:0px;">
                         <td style="font-family: 'Lato', sans-serif; font-size:48px; color:#fbb016; font-weight: bold; line-height: 44px;"></td>
                       </tr>
                             ...
                             <tbody><tr>
                               ...
                               <td height="30" align="center" style="font-family: 'Lato', sans-serif; font-size:14px; font-weight: 300; color:#333;">
                                 ...
                                 <!-- <a href="#" style="color: #333; text-decoration: none;"> -->
                                  <router-link :to="{name: 'bmi'}">Calculate BMI?</router-link>
                                  <!-- </a> -->
               ...
               <table style="border:1px solid #e2e2e2;" class="col2" width="287" border="0" align="right" cellpadding="0" cellspacing="0">
                 ...
                 <tbody><tr>
                   <td height="40" align="center" bgcolor="#333" style="font-family: 'Raleway', sans-serif; font-size:18px; color:#fbb016; line-height:30px; font-weight: bold;">Check activity level</td>
                 </tr>
                         ...
                         <td>
                           <table width="100" border="0" align="center" cellpadding="0" cellspacing="0" style=" border: 2px solid #fbb016;">
                             <tbody><tr>
                               <td width="10"></td>
                               <td height="30" align="center" style="font-family: 'Lato', sans-serif; font-size:14px; font-weight: 300; color:#333;">
                                 <!-- <a href="#" style="color: #333; text-decoration: none;">Activity Level?</a> -->
                                 <router-link :to="{name: 'activity'}">Activity Level?</router-link>
                               </td>
                               <td width="10"></td>
                             </tr>
                           </tbody></table>
...
export default {
  ...
  watch: {
    // Watch for route changes and update active button accordingly
    $route(to) {
      const path = to.path;
      if (path === '/login') {
        this.activeButton = 'login';
